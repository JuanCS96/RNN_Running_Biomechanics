...
for i in range(0, 16):
    ...
    final_model.save('Angles_Inputs_Forces'+str(i+1)+'_out'+'.h5')

matrix = np.array(matrix)

with open(r'C:\Users\juan_\Desktop\Tesis\Tesis_2\GridSearch\\' + 'Angles_Inputs_Forces.csv', 'x', newline='') as f:
    writer = csv.writer(f)      
